      ...
      <div class="container">
        <div class="row ">
          <div class="col-12 mt-20 mb-20">
            <form enctype="multipart/form-data" method="post" action="#">
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody>
                  	 <c:forEach var="cartproduct" items="${cartbean}">
                    <tr>
                      <td class="text-center"><a href="#"><img src="images/product/70x84.html" alt="iPod Classic" title="iPod Classic"></a></td>
                      <td class="text-left"><a href="product.html">${cartproduct.totalCartAmount}</a></td>
            ...
            <div id="accordion">
              <div class="card my-1">
                <div class="card-header" id="headingOne">
                  <h4 class="mb-0">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Enter your coupon here<i class="fa fa-caret-down"></i></a>
                  </h4>
                </div>
              ...
              <div class="card my-1">
                <div class="card-header" id="headingTwo">
                  <h4 class="mb-0">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Use Gift Voucher<i class="fa fa-caret-down"></i></a>
                  </h4>
                </div>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                  <div class="card-body">
                    <div class="row align-items-center">
                    <label for="input-gift" class="col-sm-4 control-label">Enter your gift voucher code here</label>
                    <div class="input-group col-sm-8">
                      <input type="text" class="form-control" id="input-gift" placeholder="Enter your gift voucher" value="" name="coupon">
                      <span class="input-group-btn">
                    <input type="button" class="btn" data-loading-text="Loading..." id="button-gift" value="Apply Coupon">
                    </span> </div>
                  </div>
                  </div>
                </div>
              ...
              <div class="card my-1">
                <div class="card-header" id="headingThree">
                  <h4 class="mb-0">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Estimate Shipping & Taxes <i class="fa fa-caret-down"></i></a>
                  </h4>
                </div>
                      ...
                      <div class="form-group required row">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control" id="input-country" name="country_id">
                            ...
                            <option value="100">IndThreesia</option>
            ...
            <form action="http://html.lionode.com/bigmarket/bm002/index.html">
