              ...
              <div class="list-group">
                <div class="list-group-item mb-10">
                  ...
                  <div id="filter-group1">
                    <div class="checkbox">
                      <label>
                        <input value="" type="checkbox"> 250gm-1kg </label>
                    </div>
                    <div class="checkbox">
                      <label>
                        <input value="" type="checkbox"> 1kg-5kg </label>
                    </div>
                    <div class="checkbox ">
                      <label>
                        <input value="" type="checkbox"> 5kg-10kg</label>
                    </div>
                    <div class="checkbox ">
                      <label>
                        <input value="" type="checkbox"> 10kg OR More </label>
                    </div>
                  </div>
                </div>
