				...
				<div class="row">
					...
					<div class="product-layout col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="product-thumb transition text-center">
							...
							<div class="image">
								<a href="category_page.html"><img
									src="<c:url value="/resources/images/cat2.png"/>" alt="Veggies"
					...
					<div class="product-layout col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="product-thumb transition text-center">
							...
							<div class="image">
								<a href="category_page.html"><img
									src="<c:url value="/resources/images/cat3.png"/>"
									alt="Del Monte Corn" title="Del Monte Corn"
									class="img-responsive"></a>
							</div>
						</div>
					</div>
					<div class="product-layout col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="product-thumb transition text-center">
							...
							<div class="image">
								<a href="category_page.html"><img
									src="<c:url value="/resources/images/cat4.png"/>"
									alt="Riced cauliflower" title="Riced cauliflower"
									class="img-responsive"></a>
							</div>
						</div>
					</div>
					<div class="product-layout col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="product-thumb transition text-center">
							...
							<div class="image">
								<a href="category_page.html"><img
									src="<c:url value="/resources/images/cat5.png"/>"
									alt="Veggies Bowl" title="Veggies Bowl" class="img-responsive"></a>
							</div>
						</div>
					</div>
					<div class="product-layout col-lg-2 col-md-3 col-sm-4 col-6">
						<div class="product-thumb transition text-center">
							...
							<div class="image">
								<a href="category_page.html"><img
									src="<c:url value="/resources/images/cat6.png"/>"
									alt="Green peas | Carrots" title="Green peas | Carrots"
									class="img-responsive"></a>
							</div>
						</div>
					</div>
