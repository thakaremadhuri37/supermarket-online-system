			...
			<div class="container">
				<div class="row ">
					<div class="col-12 my-3">
											...
											<div class="row">
												...
												<div class="col-md-6 col-12 d-flex">
													...
													<div class="register">
														...
														<h4>
															You have account? please click <a href="login.html">Login</a>
														</h4>
												...
												<div class="col-md-6 col-12 d-flex">
													...
													<div class="account-image">
														...
														<img src="<c:url value="/resources/images/account-image-placeholder.png" />" 
															alt="Account Image Placeholder" class="image-placeholder">

														<div class="account-image-upload">
															<input type="file" name="chooseFile"
																id="account-image-upload"> <label
																class="account-image-label" for="account-image-upload">Choose
																your image</label>
														</div>
									...
									<div class="col-lg-3 footer-block">
										...
										<ul>
											<li class="add">Warehouse & Offices, 12345 Street name,
												California USA</li>
											<li class="phone">(+123) 456 789 <br> (+024) 666
												888
											</li>
						...
						<script
							src="<c:url value="/resources/js/jquery.magnific-popup.js"/>"></script>
						<script
