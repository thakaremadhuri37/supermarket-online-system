...
<body onload="homePageOnLoad()">
	...
	<div class="wrapper">
		...
		<div class="breadcrumb section pt-60 pb-60">
			<div class="container">
				<h1 class="uppercase">Show all Orders</h1>
				<ul>
					<li><a href="home"><i class="fa fa-home"></i></a></li>
					<li class="active">Show all Orders</li>
				</ul>
			</div>
		</div>
						...
						<div class="table-responsive">
							...
							<table style="border: 1px solid black;"
								...
								<tr class="text-center"
									...
									<th class="text-center" class="zoom">User_Id</th>
								...
								<c:forEach var="product" items="${productList}">
									...
									<tbody align="center">
										...
										<tr
											...
											<td class="text-center" style="color: red"><a  href="showorderbyid?id=${product.order_id}" style="text-decoration: underline;">${product.order_id}</a></td>
												<td class="text-center">${product.user_id}</td>
											
											
											<td class="text-center">${product.total_price}</td>
											<td class="text-center">${product.payment_status}</td>
