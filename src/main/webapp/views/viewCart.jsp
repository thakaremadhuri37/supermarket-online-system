										...
										<tr>
											<td class="text-center"><a href="#"><img
													src="<c:url value="/resources/images/pro/${cartproduct.imagename}" />"  
													 width="60px" ></a></td>
											<td class="text-left"><a href="product.html">${cartproduct.name}
											</a></td>
					...
					<div id="accordion">
							...
							<div class="card-header" id="headingOne">
								<h4 class="mb-0">
									<a data-toggle="collapse" data-parent="#accordion"
										href="#collapseOne">Enter your coupon here<i
						...
						<div class="card my-1">
							...
							<div id="collapseTwo" class="collapse"
								...
								<div class="card-body">
									<div class="row align-items-center">
										<label for="input-gift" class="col-sm-4 control-label">Enter
											your gift voucher code here</label>
										<div class="input-group col-sm-8">
											<input type="text" class="form-control" id="input-gift"
												placeholder="Enter your gift voucher" value="" name="coupon">
											<span class="input-group-btn"> <input type="button"
												class="btn" data-loading-text="Loading..." id="button-gift"
												value="Apply Coupon">
											</span>
										</div>
									</div>
